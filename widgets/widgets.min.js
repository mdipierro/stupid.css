...
w.append(tag(options[i]).addClass('off')).append(' ');s.val(tags.join(sep)).change();};t.keyup(function(e){e.preventDefault();var code=e.keyCode||e.which;if(code==13||code==188){var k=t.val().trim().replace(/(^[,;:-]+|[,;:-]+$)/,'');if(k){w.append(tag(k)).append(' ');tags.push(k);show();}
